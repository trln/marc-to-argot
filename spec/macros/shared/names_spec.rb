...
describe MarcToArgot::Macros::Shared::Names do
  ...
  xit '(MTA) sets names, prioritizing director type over creator type' do
  ...
  xit '(MTA) sets names, setting editor over contributor, deduping relators' do
  ...
  xit '(MTA) sets names, setting 1XX to non-creator type based on relator' do
  ...
  xit '(MTA) sets names, multiple creators, initial followed by retained period at end of name' do
  ...
  xit '(MTA) sets names, keeping UNC $5, some names NOT mapping to author facet' do
  ...
  xit '(MTA) sets names, discarding fields with non-whitelisted $5' do
  ...
  xit '(MTA) sets names, including uncontrolled name fields' do
  ...
  xit '(MTA) sets names, handling 7XX with no relator term or code' do
  ...
  xit '(MTA) sets names, handling relator terms that don\'t map to a category' do
  ...
  xit '(MTA) sets names, handling sole relator code without mapping to term' do
  ...
  xit '(MTA) sets names, handling multiple relator codes when one is without mapping to term' do
  ...
  xit '(MTA) sets names from 1XX that include $t' do
